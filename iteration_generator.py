...
iteration = {
        ...
        "iterator4": "Find the largest number in {list},:add {1} to it,:and store the reuslt in {O}.:[A]", 
        ...
        "iterator9": "Find the largest number in {list},:subtract {1} from it,:and store the reuslt in {O}.:[A]", 
